...
export default function GalleryWidget() {
  ...
  // ✅ Typed animation variants with Framer Motion support
  ...
  return (
    <Card className="bg-[#363C43] border border-[#3A3F4A] rounded-3xl p-6 shadow-2xl max-w-5xl w-full overflow-hidden">
      ...
      <div className="flex items-center justify-between mb-6">
        <button className="bg-black text-white px-7 py-3 rounded-2xl font-medium text-xl shadow-md">
          Gallery
        </button>
        ...
        <div className="flex items-center gap-6">
          ...
          <Button
            ...
            className="flex items-center gap-2 bg-[#3A3F4A] hover:bg-[#4A5060] text-white text-xs px-4 py-2 rounded-full shadow-[-1px_-2px_4px_0px_rgba(255,255,255,0.3)]"
          >
